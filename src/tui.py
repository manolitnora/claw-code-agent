...
# ---------------------------------------------------------------------------
# Prompt lane (input between two dividers)
# ---------------------------------------------------------------------------
...
class StreamRenderer:
    ...
    Simple and robust — handles bold, inline code, code blocks, headers.
    Passes everything else through cleanly (tables, unicode, etc.).
    """
